	...
	return (
		<aside className='minmax'>
			<aside className='hr__nav'>
				...
				<span onClick={refreshComponent}>Malaysia</span>
			</aside>

			<div className='applicants__space__professions'>
				<Link
					to='/applicants-space/malaysia/finance-and-accounting'
					className='card'
				>
				...
				<Link
					to='/applicants-space/malaysia/digital-marketing-and-e-commerce'
					className='card'
				>
					<div className='card__img'>
						<img
				...
				<Link
					to='/applicants-space/malaysia/project-services'
					className='card'
				>
					<div className='card__img'>
						<img
